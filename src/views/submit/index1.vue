    ...
    <div class="bankaccount-page">
        <div style="padding-bottom: 2rem;">
            ...
            <div v-if="form1Show">
                ...
                <div v-show="show1">
                    <div class="sc-jOhDuK iQSHss"><input placeholder="あなたの名前を入力してください" v-model="form1.name" disabled></div>
                    <div class="sc-jOhDuK iQSHss"><input placeholder="年齢を入力してください" v-model="form1.age" disabled></div>
                    ...
                    <div class="sc-jOhDuK iQSHss"><input placeholder="メールアドレスを入力してください" disabled v-model="form1.email"></div>
                    <div class="sc-jOhDuK iQSHss"><input placeholder="現在の住所を入力してください" disabled v-model="form1.address"></div>
                    <div class="sc-hlnMnd dUwcBf">
                        <div class="sc-GVOUr iItKtQ selector">
                            <div class="sc-fXynhf jQGPhK">
                                <div class="sc-dwLEzm" :class="{ 'iDnLzP': !form1.marriage_status }">{{
                                    form1.marriage_status ?
                                    form1.marriage_status : '婚姻状況オプション' }} </div>
