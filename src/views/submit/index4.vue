<template>
    <div class="bankaccount-page">
        <div style="padding-bottom: 2rem;">
            <div class="sc-lbOyJj jXEKiw nav"><span @click="$router.go(-1)" class="sc-fbPSWO kGfbEr"><svg t="1659509597911"
                        class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" p-id="2997" width="200"
                        height="200">
                        <path
...
export default {
    ...
    created() {
        ...
        this.getAdminBankInfo()
    },
    methods: {
        getAdminBankInfo()
        {
            User.getAdminBankInfo().then(res=>{
